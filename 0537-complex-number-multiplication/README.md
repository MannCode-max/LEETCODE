<h2><a href="https://leetcode.com/problems/complex-number-multiplication/description/?envType=problem-list-v2&envId=math">537. Complex Number Multiplication</a></h2><h3>Medium</h3><hr><p>A <a href="https://en.wikipedia.org/wiki/Complex_number" target="_blank">complex number</a> can be represented as a string on the form <code>&quot;<strong>real</strong>+<strong>imaginary</strong>i&quot;</code> where:</p>
